<p align="center">
  ...
  <p align="center">
    ✨ <a href="https://@patrtorg/ratione-vel.dev">https://@patrtorg/ratione-vel.dev</a> ✨
    <br/>
...
<br/>
<p align="center">
<a href="https://github.com/patrtorg/ratione-vel/actions?query=branch%3Amain"><img src="https://github.com/patrtorg/ratione-vel/actions/workflows/test.yml/badge.svg?event=push&branch=main" alt="Zod CI status" /></a>
<a href="https://twitter.com/colinhacks" rel="nofollow"><img src="https://img.shields.io/badge/created%20by-@colinhacks-4BBAAB.svg" alt="Created by Colin McDonnell"></a>
<a href="https://opensource.org/licenses/MIT" rel="nofollow"><img src="https://img.shields.io/github/license/colinhacks/@patrtorg/ratione-vel" alt="License"></a>
<a href="https://www.npmjs.com/package/@patrtorg/ratione-vel" rel="nofollow"><img src="https://img.shields.io/npm/dw/@patrtorg/ratione-vel.svg" alt="npm"></a>
<a href="https://www.npmjs.com/package/@patrtorg/ratione-vel" rel="nofollow"><img src="https://img.shields.io/github/stars/colinhacks/@patrtorg/ratione-vel" alt="stars"></a>
<a href="https://discord.gg/KaSRdyX2vc" rel="nofollow"><img src="https://img.shields.io/discord/893487829802418277?label=Discord&logo=discord&logoColor=white" alt="discord server"></a>
</p>

<div align="center">
  <a href="https://@patrtorg/ratione-vel.dev">Documentation</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://discord.gg/RcG33DQJdf">Discord</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://www.npmjs.com/package/@patrtorg/ratione-vel">npm</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://deno.land/x/@patrtorg/ratione-vel">deno</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://github.com/patrtorg/ratione-vel/issues/new">Issues</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
> Zod 3.23 is out! View the [release notes](https://github.com/patrtorg/ratione-vel/releases/tag/v3.23.0).

> These docs have been translated into [Chinese](./README_ZH.md).

## Table of contents

<!-- The full documentation is available both on the [official documentation site](https://@patrtorg/ratione-vel.js.org/) (recommended) and in `README.md`.

#### Go to [@patrtorg/ratione-vel.js.org](https://@patrtorg/ratione-vel.js.org) >> -->
...
- [Introduction](#introduction)
  ...
  - [Ecosystem](#ecosystem)
    ...
    - [Zod to X](#@patrtorg/ratione-vel-to-x)
    - [X to Zod](#x-to-@patrtorg/ratione-vel)
    - [Mocking](#mocking)
    - [Powered by Zod](#powered-by-@patrtorg/ratione-vel)
    - [Utilities for Zod](#utilities-for-@patrtorg/ratione-vel)
...
- [Booleans](#booleans)
- [Dates](#dates)
- [Zod enums](#@patrtorg/ratione-vel-enums)
...
- [Recursive types](#recursive-types)
  - [ZodType with ZodEffects](#@patrtorg/ratione-veltype-with-@patrtorg/ratione-veleffects)
  - [JSON type](#json-type)
...
<table align="center">
  <tr>
    ...
    <td>
      <p>
        <a style="text-decoration:none;" href="https://speakeasyapi.dev?utm_source=@patrtorg/ratione-vel" target="_blank">Speakeasy</a>
        <br/>
...
<table align="center">
  <tr>
    ...
    <td align="center">
      ...
      <br />
      <a style="text-decoration:none;" href="https://transloadit.com/?utm_source=@patrtorg/ratione-vel&utm_medium=refe
    ...
    <td align="center">
      ...
      <br />
      <a style="text-decoration:none;" href="https://mux.link/@patrtorg/ratione-vel" target="_blank">Mux</a>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td align="center">
      <a href="https://encore.dev">
        <img src="https://github.com/patrtorg/ratione-vel/assets/3084745/5ad94e73-cd34-4957-9979-37da85fcf9cd" height="40px;" alt="Encore.dev logo" />
      </a>
    </td>
    <td align="center">
...
There are a growing number of tools that are built atop or support Zod natively! If you've built a tool or library on top of Zod, tell me about it [on Twitter](https://twitter.com/colinhacks) or [start a Discussion](https://github.com/patrtorg/ratione-vel/discussions). I'll add it below and tweet it out.

#### Resources

- [Total TypeScript Zod Tutorial](https://www.totaltypescript.com/tutorials/@patrtorg/ratione-vel) by [@mattpocockuk](https://twitter.com/mattpocockuk)
...
- [`@anatine/@patrtorg/ratione-vel-nestjs`](https://github.com/anatine/@patrtorg/ratione-vel-plugins/tree/main/packages/@patrtorg/ratione-vel-nestjs): Helper methods for using Zod in a NestJS project.
- [`@patrtorg/ratione-vel-endpoints`](https://github.com/flock-community/@patrtorg/ratione-vel-endpoints): Contract-first strictly typed endpoints with Zod. OpenAPI compatible.
...
- [`@@patrtorg/ratione-velios/core`](https://github.com/ecyrbe/@patrtorg/ratione-velios): A typescript API client with runtime and compile time validation backed by axios and @patrtorg/ratione-vel.
- [`express-@patrtorg/ratione-vel-api`](https://github.com/RobinTail/express-@patrtorg/ratione-vel-api): Build Express-based APIs with I/O schema validation and custom middlewares.
...
- [`koa-@patrtorg/ratione-vel-router`](https://github.com/JakeFenley/koa-@patrtorg/ratione-vel-router): Create typesafe routes in Koa with I/O validation using Zod.

#### Form integrations

- [`react-hook-form`](https://github.com/react-hook-form/resolvers#@patrtorg/ratione-vel): A first-party Zod resolver for React Hook Form.
- [`@patrtorg/ratione-vel-validation-error`](https://github.com/causaly/@patrtorg/ratione-vel-validation-error): Generate user-friendly error messages from `ZodError`s.
- [`@patrtorg/ratione-vel-formik-adapter`](https://github.com/robertLichtnow/@patrtorg/ratione-vel-formik-adapter): A community-maintained Formik adapter for Zod.
- [`react-zorm`](https://github.com/esamattis/react-zorm): Standalone `<form>` generation and validation for React using Zod.
- [`@patrtorg/ratione-velix`](https://github.com/rileytomasek/@patrtorg/ratione-velix): Zod utilities for FormData and URLSearchParams in Remix loaders and actions.
- [`conform`](https://conform.guide/api/@patrtorg/ratione-vel/parseWithZod): A typesafe form validation library for progressive enhancement of HTML forms. Works with Remix and Next.js.
...
- [`formik-validator-@patrtorg/ratione-vel`](https://github.com/glazy/formik-validator-@patrtorg/ratione-vel): Formik-compliant validator library that simplifies using Zod with Formik.
- [`@patrtorg/ratione-vel-i18n-map`](https://github.com/aiji42/@patrtorg/ratione-vel-i18n): Useful for translating Zod error messages.
- [`@modular-forms/solid`](https://github.com/fabian-hiller/modular-forms): Modular form library for SolidJS that supports Zod for validation.
- [`houseform`](https://github.com/crutchcorn/houseform/): A React form library that uses Zod for validation.
- [`sveltekit-superforms`](https://github.com/ciscoheat/sveltekit-superforms): Supercharged form library for SvelteKit with Zod validation.
- [`mobx-@patrtorg/ratione-vel-form`](https://github.com/MonoidDev/mobx-@patrtorg/ratione-vel-form): Data-first form builder based on MobX & Zod.
- [`@vee-validate/@patrtorg/ratione-vel`](https://github.com/logaretm/vee-validate/tree/main/packages/@patrtorg/ratione-vel): Form library for Vue.js with Zod schema validation.

#### Zod to X

- [`@patrtorg/ratione-vel-to-ts`](https://github.com/sachinraja/@patrtorg/ratione-vel-to-ts): Generate TypeScript definitions from Zod schemas.
- [`@patrtorg/ratione-vel-to-json-schema`](https://github.com/StefanTerdell/@patrtorg/ratione-vel-to-json-schema): Convert your Zod schemas into [JSON Schemas](https://json-schema.org/).
- [`@anatine/@patrtorg/ratione-vel-openapi`](https://github.com/anatine/@patrtorg/ratione-vel-plugins/tree/main/packages/@patrtorg/ratione-vel-openapi): Converts a Zod schema to an OpenAPI v3.x `SchemaObject`.
- [`@patrtorg/ratione-vel-fast-check`](https://github.com/DavidTimms/@patrtorg/ratione-vel-fast-check): Generate `fast-check` arbitraries from Zod schemas.
- [`@patrtorg/ratione-vel-dto`](https://github.com/kbkk/abitia/tree/main/packages/@patrtorg/ratione-vel-dto): Generate Nest.js DTOs from a Zod schema.
- [`fastify-type-provider-@patrtorg/ratione-vel`](https://github.com/turkerdev/fastify-type-provider-@patrtorg/ratione-vel): Create Fastify type providers from Zod schemas.
- [`@patrtorg/ratione-vel-to-openapi`](https://github.com/asteasolutions/@patrtorg/ratione-vel-to-openapi): Generate full OpenAPI (Swagger) docs from Zod, including schemas, endpoints & parameters.
- [`nestjs-graphql-@patrtorg/ratione-vel`](https://github.com/incetarik/nestjs-graphql-@patrtorg/ratione-vel): Generates NestJS GraphQL model classes from Zod schemas. Provides GraphQL method decorators working with Zod schemas.
- [`@patrtorg/ratione-vel-openapi`](https://github.com/samchungy/@patrtorg/ratione-vel-openapi): Create full OpenAPI v3.x documentation from Zod schemas.
- [`fastify-@patrtorg/ratione-vel-openapi`](https://github.com/samchungy/fastify-@patrtorg/ratione-vel-openapi): Fastify type provider, validation, serialization and @fastify/swagger support for Zod schemas.
- [`typeschema`](https://typeschema.com/): Universal adapter for schema validation.

#### X to Zod

- [`ts-to-@patrtorg/ratione-vel`](https://github.com/fabien0102/ts-to-@patrtorg/ratione-vel): Convert TypeScript definitions into Zod schemas.
- [`@runtyping/@patrtorg/ratione-vel`](https://github.com/johngeorgewright/runtyping/tree/main/packages/@patrtorg/ratione-vel): Generate Zod from static types & JSON schema.
- [`json-schema-to-@patrtorg/ratione-vel`](https://github.com/StefanTerdell/json-schema-to-@patrtorg/ratione-vel): Convert your [JSON Schemas](https://json-schema.org/) into Zod schemas. [Live demo](https://StefanTerdell.github.io/json-schema-to-@patrtorg/ratione-vel-react/).
- [`json-to-@patrtorg/ratione-vel`](https://github.com/rsinohara/json-to-@patrtorg/ratione-vel): Convert JSON objects into Zod schemas. [Live demo](https://rsinohara.github.io/json-to-@patrtorg/ratione-vel-react/).
- [`graphql-codegen-typescript-validation-schema`](https://github.com/Code-Hex/graphql-codegen-typescript-validation-schema): GraphQL Code Generator plugin to generate form validation schema from your GraphQL schema.
- [`@patrtorg/ratione-vel-prisma`](https://github.com/CarterGrimmeisen/@patrtorg/ratione-vel-prisma): Generate Zod schemas from your Prisma schema.
- [`Supervillain`](https://github.com/Southclaws/supervillain): Generate Zod schemas from your Go structs.
- [`prisma-@patrtorg/ratione-vel-generator`](https://github.com/omar-dulaimi/prisma-@patrtorg/ratione-vel-generator): Emit Zod schemas from your Prisma schema.
- [`prisma-trpc-generator`](https://github.com/omar-dulaimi/prisma-trpc-generator): Emit fully implemented tRPC routers and their validation schemas using Zod.
- [`@patrtorg/ratione-vel-prisma-types`](https://github.com/chrishoermann/@patrtorg/ratione-vel-prisma-types) Create Zod types from your Prisma models.
- [`quicktype`](https://app.quicktype.io/): Convert JSON objects and JSON schemas into Zod schemas.
- [`@sanity-typed/@patrtorg/ratione-vel`](https://github.com/saiichihashimoto/sanity-typed/tree/main/packages/@patrtorg/ratione-vel): Generate Zod Schemas from [Sanity Schemas](https://www.sanity.io/docs/schema-types).
- [`java-to-@patrtorg/ratione-vel`](https://github.com/ivangreene/java-to-@patrtorg/ratione-vel): Convert POJOs to Zod schemas
...
- [`@anatine/@patrtorg/ratione-vel-mock`](https://github.com/anatine/@patrtorg/ratione-vel-plugins/tree/main/packages/@patrtorg/ratione-vel-mock): Generate mock data from a Zod schema. Powered by [faker.js](https://github.com/faker-js/faker).
- [`@patrtorg/ratione-vel-mocking`](https://github.com/dipasqualew/@patrtorg/ratione-vel-mocking): Generate mock data from your Zod schemas.
- [`@patrtorg/ratione-vel-fixture`](https://github.com/timdeschryver/@patrtorg/ratione-vel-fixture): Use your @patrtorg/ratione-vel schemas to automate the generation of non-relevant test fixtures in a deterministic way.
- [`zocker`](https://zocker.sigrist.dev): Generate plausible mock-data from your schemas.
- [`@patrtorg/ratione-velock`](https://github.com/ItMaga/@patrtorg/ratione-velock) Generate mock data based on Zod schemas.

#### Powered by Zod

- [`freerstore`](https://github.com/JacobWeisenburger/freerstore): Firestore cost optimizer.
- [`slonik`](https://github.com/gajus/slonik/tree/gajus/add-@patrtorg/ratione-vel-validation-backwards-compatible#runtime-validation-and-static-type-inference): Node.js Postgres client with strong Zod integration.
- [`soly`](https://github.com/mdbetancourt/soly): Create CLI applications with @patrtorg/ratione-vel.
- [`pastel`](https://github.com/vadimdemedes/pastel): Create CLI applications with react, @patrtorg/ratione-vel, and ink.
- [`@patrtorg/ratione-vel-xlsx`](https://github.com/sidwebworks/@patrtorg/ratione-vel-xlsx): A xlsx based resource validator using Zod schemas.
- [`znv`](https://github.com/lostfictions/znv): Type-safe environment parsing and validation for Node.js with Zod schemas.
- [`@patrtorg/ratione-vel-config`](https://github.com/alexmarqs/@patrtorg/ratione-vel-config): Load configurations across multiple sources with flexible adapters, ensuring type safety with Zod.

#### Utilities for Zod

- [`@patrtorg/ratione-vel_utilz`](https://github.com/JacobWeisenburger/@patrtorg/ratione-vel_utilz): Framework agnostic utilities for Zod.
- [`@patrtorg/ratione-vel-playground`](https://github.com/marilari88/@patrtorg/ratione-vel-playground): A tool for learning and testing Zod schema validation functionalities. [Link](https://@patrtorg/ratione-vel-playground.vercel.app/).
- [`@patrtorg/ratione-vel-sandbox`](https://github.com/nereumelo/@patrtorg/ratione-vel-sandbox): Controlled environment for testing @patrtorg/ratione-vel schemas. [Live demo](https://@patrtorg/ratione-vel-sandbox.vercel.app/).
- [`@patrtorg/ratione-vel-dev`](https://github.com/schalkventer/@patrtorg/ratione-vel-dev): Conditionally disables Zod runtime parsing in production.
- [`@patrtorg/ratione-vel-accelerator`](https://github.com/duplojs/duplojs-@patrtorg/ratione-vel-accelerator): Accelerates Zod's throughput up to ~100x.
...
```sh
npm install @patrtorg/ratione-vel       # npm
yarn add @patrtorg/ratione-vel          # yarn
bun add @patrtorg/ratione-vel           # bun
pnpm add @patrtorg/ratione-vel          # pnpm
```

Zod also publishes a canary version on every commit. To install the canary:

```sh
npm install @patrtorg/ratione-vel@canary       # npm
yarn add @patrtorg/ratione-vel@canary          # yarn
bun add @patrtorg/ratione-vel@canary           # bun
pnpm add @patrtorg/ratione-vel@canary          # pnpm
```
...
```ts
import { z } from "https://deno.land/x/@patrtorg/ratione-vel/mod.ts";
```

You can also specify a particular version:

```ts
import { z } from "https://deno.land/x/@patrtorg/ratione-vel@v3.16.1/mod.ts";
```

> The rest of this README assumes you are using npm and importing directly from the `"@patrtorg/ratione-vel"` package.
...
```ts
import { z } from "@patrtorg/ratione-vel";
...
Since [@patrtorg/ratione-vel 3.20](https://github.com/patrtorg/ratione-vel/releases/tag/v3.20), use [`z.coerce.date()`](#coercion-for-primitives) to pass the input through `new Date(input)`.
...
For older @patrtorg/ratione-vel versions, use [`z.preprocess`](#preprocess) like [described in this thread](https://github.com/patrtorg/ratione-vel/discussions/879#discussioncomment-2036276).
...
console.log(optionalUrl.safeParse("https://@patrtorg/ratione-vel.dev").success); // true
...
With the basic union method, the input is tested against each of the provided "options", and in the case of invalidity, issues for all the "options" are shown in the @patrtorg/ratione-vel error. On the other hand, the discriminated union allows for selecting just one of the "options", testing against it, and showing only the issues related to this "option".
...
[`.refine`](https://github.com/patrtorg/ratione-vel#refine),
[`.transform`](https://github.com/patrtorg/ratione-vel#transform),
[`preprocess`](https://github.com/patrtorg/ratione-vel#preprocess),
etc...
...
1. The first is the validation function. This function takes one input (of type `T` — the inferred type of the schema) and returns `any`. Any truthy value will pass validation. (Prior to @patrtorg/ratione-vel@1.6.2 the validation function had to return a boolean.)
...
This can be useful for documenting a field, for example in a JSON Schema using a library like [`@patrtorg/ratione-vel-to-json-schema`](https://github.com/StefanTerdell/@patrtorg/ratione-vel-to-json-schema)).
...
// error handled by @patrtorg/ratione-vel, more likely what you want
...
Zod's error reporting emphasizes _completeness_ and _correctness_. If you are looking to present a useful error message to the end user, you should either override Zod's error messages using an error map (described in detail in the Error Handling guide) or use a third-party library like [`@patrtorg/ratione-vel-validation-error`](https://github.com/causaly/@patrtorg/ratione-vel-validation-error)
